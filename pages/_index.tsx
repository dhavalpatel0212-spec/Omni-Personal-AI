...
export default function HomePage() {
  ...
  // Immediately redirect authenticated users without showing loading state
  if (authState.type === "authenticated") {
    return <Navigate to="/dashboard" replace />;
  }

  // For loading state, show minimal content to avoid delay perception
  if (authState.type === "loading") {
    // Return minimal content that doesn't interfere with redirect
    return (
      <div className={styles.minimalLoading}>
        <div className={styles.minimalLoadingSpinner}></div>
      </div>
    );
  }
